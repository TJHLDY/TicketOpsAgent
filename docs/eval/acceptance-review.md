...
For ChatGPT or external review, use the generated acceptance report summary from `target/agent-eval/acceptance-report.md` together with the repository docs listed in this file.
