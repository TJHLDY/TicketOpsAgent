...
$lines.Add('- SOP retrieval uses embedding-based Spring AI SimpleVectorStore with source citations and low-similarity refusal; it is not production pgvector.')
$lines.Add('')
